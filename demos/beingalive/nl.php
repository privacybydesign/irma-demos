<?php
$content = [
    "intro" => "Handig om te bewijzen dat je leeft voor pensioen- of AOW-betalingen.",
    "benefits" => [
        "Bespaart je een trip naar het gemeentehuis",
        "Geen fysieke formulieren die per post verstuurd moeten worden"
    ],
    "data" => [
