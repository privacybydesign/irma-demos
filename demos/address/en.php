<?php
$content = [
	"intro" => "Useful for quickly filling forms or getting access to address based info.",
	"benefits" => [
		"Share the address as it appears in the citizen registry",
		"Full address or just the postal code/city",
	],
	"data" => [
